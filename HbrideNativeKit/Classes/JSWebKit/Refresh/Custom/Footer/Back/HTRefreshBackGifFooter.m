...
#import "HTRefreshBackGifFooter.h"
@interface HTRefreshBackGifFooter()
{
...
@end
@implementation HTRefreshBackGifFooter
#pragma mark - 懒加载
- (UIImageView *)gifView
{
    if (!_gifView) {
...
- (void)placeSubviews
{
    ...
    if (self.stateLabel.hidden) {
        ...
        self.gifView.ht_w = self.ht_w * 0.5 - self.labelLeftInset - self.stateLabel.ht_textWidth * 0.5;
    }
}
