...
#import "HTTabBar.h"
#define CYTABBARCONTROLLER ((HTTabBarController *)self.tabBarController)
...
/** 自定义的tabbar */
@property (strong , nonatomic) HTTabBar* tabbar;
...
/**
 ...
 @return TabBarController
 */
+ (instancetype)tabBarControllerWitnAddChildVCBlock:(void(^)(HTTabBarController *tabBarVC))addVCBlock;
