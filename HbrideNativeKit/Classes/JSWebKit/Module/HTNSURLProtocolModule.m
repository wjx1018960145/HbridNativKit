...
#import "HTNSURLProtocolModule.h"
...
@interface HTNSURLProtocolModule()
...
@implementation HTNSURLProtocolModule
...
//        NSString *path = [docPath stringByAppendingPathComponent:fileName];
        ...
        UIImage *img = [[HTImageCache sharedImageCache] imageFromDiskCacheForKey:key];
        ...
        if (img) {
            ...
            NSString *mimeType = [NSData ht_contentTypeForImageData:data];
            [self sendResponseWithData:data mimeType:mimeType];
