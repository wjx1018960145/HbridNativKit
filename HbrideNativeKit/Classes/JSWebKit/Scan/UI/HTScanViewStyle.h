...
/**
 扫码区域动画效果
 */
typedef NS_ENUM(NSInteger,HTScanViewAnimationStyle)
{
    HTScanViewAnimationStyle_LineMove,   //线条上下移动
    HTScanViewAnimationStyle_NetGrid,//网格
    HTScanViewAnimationStyle_LineStill,//线条停止在扫码区域中央
    HTScanViewAnimationStyle_None    //无动画
...
/**
 扫码区域4个角位置类型
 */
typedef NS_ENUM(NSInteger, HTScanViewPhotoframeAngleStyle)
{
    HTScanViewPhotoframeAngleStyle_Inner,//内嵌，一般不显示矩形框情况下
    HTScanViewPhotoframeAngleStyle_Outer,//外嵌,包围在矩形框的4个角
    HTScanViewPhotoframeAngleStyle_On   //在矩形框的4个角上，覆盖
};

NS_ASSUME_NONNULL_BEGIN

@interface HTScanViewStyle : NSObject
...
/**
 @brief  扫码区域的4个角类型
 */
@property (nonatomic, assign) HTScanViewPhotoframeAngleStyle photoframeAngleStyle;
...
/**
 @brief  扫码动画效果:线条或网格
 */
@property (nonatomic, assign) HTScanViewAnimationStyle anmiationStyle;
