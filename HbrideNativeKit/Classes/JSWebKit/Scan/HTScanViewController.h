...
//UI
#ifdef HTScan_Define_UI
#import "HTScanView.h"
#endif


#ifdef HTScan_Define_Native
#import "HTScanNative.h" //原生扫码封装
#endif
 ...
 */
@protocol HTScanViewControllerDelegate <NSObject>
@optional
- (void)scanResultWithArray:(NSArray<HTScanResult*>*)array;
@end
@interface HTScanViewController : UIViewController
...
@property (nonatomic, weak) id<HTScanViewControllerDelegate> delegate;
...
@property (nonatomic, strong) HTScanViewStyle *style;
#endif
...
/**
 @brief  扫码功能封装对象
 */
@property (nonatomic,strong) HTScanNative* scanObj;
...
#ifdef LBXScan_Define_UI
@property (nonatomic,strong) HTScanView* qRScanView;
#endif
