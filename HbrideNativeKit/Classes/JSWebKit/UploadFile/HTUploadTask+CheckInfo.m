...
@implementation HTUploadTask (CheckInfo)
...
{
    NSString *uploadFileInfoUrl=[NSString stringWithFormat:@"%@",[[HTFileUploadManager shardUploadManager] url]];
