...
@end
@interface HTResultSet () {
    NSMutableDictionary *_columnNameToIndexMap;
}
@end

@implementation HTResultSet

+ (instancetype)resultSetWithStatement:(HTStatement *)statement usingParentDatabase:(HTDatabase*)aDB {
    
    HTResultSet *rs = [[HTResultSet alloc] init];
    ...
    return HTDBReturnAutoreleased(rs);
}
...
- (void)dealloc {
    ...
    HTDBRelease(_columnNameToIndexMap);
...
- (NSDictionary *)resultDict {
    ...
    if (num_cols > 0) {
        ...
        return HTDBReturnAutoreleased([dict copy]);
    }
    else {
